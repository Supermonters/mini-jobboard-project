...
Open [http://localhost:3000](http://localhost:3000). On first visit the board seeds itself with 10 sample jobs. Use **Reset demo** in the header to restore them at any time.
